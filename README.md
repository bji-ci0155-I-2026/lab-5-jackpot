...
Un video demostrando la ejecución del código de ejemplo para el ATmega328P se puede encontrar aquí: [arduino-memory](./media/arduino-memory.mp4)
...
* D. Lacamera, *Embedded Systems Architecture: Design and write software for embedded devices to build safe and connected systems*, 2nd ed., Birmingham, UK: Packt Publishing, 2023,. 
